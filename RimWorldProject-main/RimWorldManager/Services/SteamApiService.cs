...
public class SteamMod
{
    ...
    public string Compatibility { get; set; } = "1.5 / 1.6";
...
public class SteamApiService
{
    ...
    {
        // Fallback для пустого запроса (по категории)
        ...
        var url = $"https://api.steampowered.com/IPublishedFileService/QueryFiles/v1/" +
                  ...
                  $"&numperpage=20&return_previews=true&return_metadata=true&return_short_description=true" +
                  $"&return_tags=true&query_type=0";
