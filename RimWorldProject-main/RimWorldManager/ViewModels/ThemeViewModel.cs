...
public class ThemeViewModel : INotifyPropertyChanged
{
    ...
    public Color AccentSecondary => _themeService.GetAccentSecondary();
    public Color AccentLight => _themeService.GetAccentLight();
    public Color AccentDark => _themeService.GetAccentDark();
    ...
    public Color MenuBg => _themeService.GetMenuBg();
    public Color MenuSelected => _themeService.GetMenuSelected();
    ...
    private void NotifyAll()
    {
        ...
        OnPropertyChanged(nameof(AccentSecondary));
        OnPropertyChanged(nameof(AccentLight));
        OnPropertyChanged(nameof(AccentDark));
        ...
        OnPropertyChanged(nameof(MenuBg));
        OnPropertyChanged(nameof(MenuSelected));
    }
